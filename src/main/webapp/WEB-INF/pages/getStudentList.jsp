...
<head>
    ...
    <!-- jQuery -->
    <script src="${pageContext.request.contextPath}/resources/static/css/jquery/jquery-ui.css"></script>
    <!-- Font Awesome Icons -->
...
<!-- jQuery -->
<script src="${pageContext.request.contextPath}/resources/static/js/jquery/jquery-3.5.1.js"></script>
<!-- jQuery -->
<script src="${pageContext.request.contextPath}/resources/static/js/jquery/jquery-3.6.0.js"></script>
<!-- jQuery -->
<script src="${pageContext.request.contextPath}/resources/static/js/jquery/jquery-ui.js"></script>
<!-- jQuery -->
...
<div id="studentDialog" title="New Student">
</div>
</body>
</html>
